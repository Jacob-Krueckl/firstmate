...
`../../../bin/fm-harness.sh` prints firstmate's own harness from a native hook event binding when supplied, then verified environment markers and process ancestry.
