...
Codex and OpenCode are also verified and supported as primary harnesses; their supervision requirements and supported surfaces are described in the [Codex protocol](docs/supervision-protocols/codex.md) and [OpenCode protocol](docs/supervision-protocols/opencode.md).
